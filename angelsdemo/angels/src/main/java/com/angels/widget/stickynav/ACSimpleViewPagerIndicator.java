...
public class ACSimpleViewPagerIndicator extends LinearLayout
{
	...
	public ACSimpleViewPagerIndicator(Context context)
	{
		this(context, null);
	}

	public ACSimpleViewPagerIndicator(Context context, AttributeSet attrs)
	{
		super(context, attrs);
