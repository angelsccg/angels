...
public class ToolsActivity extends BaseActivity implements OnClickListener{
	...
	public void onClick(View v) {
		...
		case 0:
		{
			Intent intent = new Intent(this, TextJustfyActivity.class);
			startActivity(intent);
		}
			break;
		case 1:
		{	
			Intent intent = new Intent(this, EditJustfyActivity.class);
			startActivity(intent);
		}
			break;
		case 2:
	...
	private void showDoubleDatePickerDialog() {
		...
		ACDoubleDatePickerDialog dialog = new ACDoubleDatePickerDialog(ToolsActivity.this, 0, new ACDoubleDatePickerDialog.OnDateSetListener() {
		     @Override
...
//		   			et.setText(textString);
		            Toast.makeText(ToolsActivity.this, textString, Toast.LENGTH_SHORT).show();
		     }
