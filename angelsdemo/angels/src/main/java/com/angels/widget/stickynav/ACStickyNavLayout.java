...
public class ACStickyNavLayout extends LinearLayout {
	...
	public ACStickyNavLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	protected void onFinishInflate() {
		...
		View view = findViewById(R.id.id_stickynavlayout_buttomview);
