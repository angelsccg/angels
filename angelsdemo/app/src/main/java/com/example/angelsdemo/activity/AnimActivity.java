...
public class AnimActivity extends BaseActivity implements OnClickListener{
	...
	private void showDoubleDatePickerDialog() {
		...
		ACDoubleDatePickerDialog dialog = new ACDoubleDatePickerDialog(AnimActivity.this, 0, new ACDoubleDatePickerDialog.OnDateSetListener() {
		     @Override
...
//		   			et.setText(textString);
		            Toast.makeText(AnimActivity.this, textString, Toast.LENGTH_SHORT).show();
		     }
