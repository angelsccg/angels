package com.angels.widget.stickynav;
...
public class ACStickyNavLayout3 extends LinearLayout {
	/**上部分*/
	private View mTop;
	/**中部分（上滑悬浮置顶）*/
	private View mNav;
//	private ViewPager mViewPager;
	...
	public ACStickyNavLayout3(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	protected void onFinishInflate() {
		...
		mButtom = findViewById(R.id.id_stickynavlayout_buttomview);
...
//		}
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		ViewGroup.LayoutParams params = mButtom.getLayoutParams();
	...
	private void getCurrentScrollView() {
		if (mButtom instanceof ViewPager) {
			ViewPager mViewPager = (ViewPager)mButtom;
			...
			mInnerScrollView = (ViewGroup) this.findViewById(R.id.id_stickynavlayout_innerscrollview);
		}
	}
