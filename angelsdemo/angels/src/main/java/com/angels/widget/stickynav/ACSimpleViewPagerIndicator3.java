...
public class ACSimpleViewPagerIndicator3 extends LinearLayout
{
	...
	public ACSimpleViewPagerIndicator3(Context context)
	{
		this(context, null);
	}

	public ACSimpleViewPagerIndicator3(Context context, AttributeSet attrs)
	{
		super(context, attrs);
	...
	private void generateTitleView()
	{
		...
		for (int i = 0; i < count; i++)
		{
			...
			tv.setOnClickListener(new OnClickListener()
			{
				...
				{
					ACListenerConstans.mQunZuPager .setCurrentItem(finalI);
				}
			});
			addView(tv);
		}
