...
import com.example.angelsdemo.activity.http.GPRSActivity;
import com.example.angelsdemo.activity.http.GetAndPostActivity;
...
public class HttpActivity extends BaseActivity implements OnClickListener{
	public static final String[] btnNames= {"get和post数据请求","GPRS通信","wifi连接"};
	...
	public void onClick(View v) {
		...
		case 1:
		{
			Intent intent = new Intent(this, GPRSActivity.class);
			startActivity(intent);
		}
			break;
		case 2:
	...
	private void showDoubleDatePickerDialog() {
		...
		ACDoubleDatePickerDialog dialog = new ACDoubleDatePickerDialog(HttpActivity.this, 0, new ACDoubleDatePickerDialog.OnDateSetListener() {
		     @Override
...
//		   			et.setText(textString);
		            Toast.makeText(HttpActivity.this, textString, Toast.LENGTH_SHORT).show();
		     }
