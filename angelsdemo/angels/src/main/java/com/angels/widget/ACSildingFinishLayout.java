...
/** 
 * 1, 自定义可以滑动的RelativeLayout, 类似于IOS的滑动删除页面效果，当我们要使用 
 ...
 * 3,讲Activity 主题改成半透明或者透明相关的主题  如:android:theme="@android:style/Theme.Translucent"
 * @android:style/Theme.Translucent.NoTitleBar  
 *  @android:style/Theme.Translucent.NoTitleBar.Fullscreen
 */  
/**
 * 
* @ClassName: SildingFinishLayout 
* @Description: TODO(这里用一句话描述这个类的作用) 
* @author angelsC
* @date 2015-10-30 下午3:02:53 
*
 */
public class ACSildingFinishLayout extends RelativeLayout implements  
        OnTouchListener {  
    /** 
    ...
    public ACSildingFinishLayout(Context context, AttributeSet attrs) {  
        this(context, attrs, 0);  
    }  
  
    public ACSildingFinishLayout(Context context, AttributeSet attrs, int defStyle) {  
