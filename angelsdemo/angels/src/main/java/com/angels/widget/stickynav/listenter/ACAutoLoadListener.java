package com.angels.widget.stickynav.listenter;
 ...
 * 滚动至列表底部，读取下一页数据
 */
public class ACAutoLoadListener implements OnScrollListener {
    ...
    public ACAutoLoadListener(AutoLoadCallBack callback) {
