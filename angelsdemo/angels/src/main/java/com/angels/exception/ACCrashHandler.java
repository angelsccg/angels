 ...
 * 
 */
public class ACCrashHandler implements UncaughtExceptionHandler {
    // TAG
    ...
    private static ACCrashHandler instance = null;
     ...
     */
    public static ACCrashHandler getInstance() {
        if (null == instance) {
            instance = new ACCrashHandler();
        }
        return instance;
    }
...
//                        + File.separator + "crash/";
                String path = Environment.getExternalStorageDirectory() + "/angels/angels_exception/";
