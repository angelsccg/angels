...
import com.example.angelsdemo.utils.ImageProcessing;
import com.example.angelsdemo.utils.WaveView;
 ...
 *
 */
public class HeartCameraActivity extends BaseActivity {
    //曲线
...
//			addY=250;
            ...
            if(gx<200){
                if(hua[20]>1){
                    Toast.makeText(HeartCameraActivity.this, "请用您的指尖盖住摄像头镜头！", Toast.LENGTH_SHORT).show();
                    hua[20]=0;}
                hua[20]++;
                return;}
            else
    ...
    private static Camera.PreviewCallback previewCallback = new Camera.PreviewCallback() {
        public void onPreviewFrame(byte[] data, Camera cam) {
            ...
            int imgSum = ImageProcessing.decodeYUV420SPtoRedSum(data.clone(),height,width);
            gx=imgAvg;


            /*===========================================================*/
//            int maxY = 7000;
//            int h = (imgSum%1000000)/100;
//            if(lastNum != 0 && imgSum > 6000000){
//                int difference = imgSum - lastNum;//差值
//                if(difference > 0){
//                    maxY =
//
//                }else{
...
//                data.add(0,0f);
//            }
//            waveView.setVolume(imgAvg);
            waveView.setVolume(imgSum);
            ...
            for (int i = 0; i < averageArray.length; i++) {
                if (averageArray[i] > 0) {
                    ...
                    averageArrayCnt++;
                    ACLogUtil.i("摄像心率-->averageArrayAvg:" + averageArrayAvg + ",averageArrayCnt:"+averageArrayCnt);
                }
            }
            //计算平均值
            ...
            if (imgAvg < rollingAverage) {
                ...
                if (newType != currentType) {
                    ...
                    ACLogUtil.i("摄像心率-->脉冲 beats=" + beats);
                }
            ...
            ACLogUtil.i("摄像心率-->totalTimeInSecs："+ totalTimeInSecs);
            if (totalTimeInSecs >= 2) {
                double bps = (beats / totalTimeInSecs);
                int dpm = (int) (bps * 60d);
                ACLogUtil.i("摄像心率-->dpm："+ dpm + ",imgAvg:"+imgAvg + ",beats:"+beats +",totalTimeInSecs："+ totalTimeInSecs);
                ...
                ACLogUtil.i("摄像心率-->您的的心率是"+String.valueOf(beatsAvg)+"  zhi:"+String.valueOf(beatsArray.length)
